    ...
    <ComponentCard title="Modal Based Alerts">
      <div className="flex flex-wrap items-center gap-3">
        <button
          ...
          className="px-4 py-2.5 text-sm font-medium text-white rounded-xl tracking-[0.01em] active:scale-[0.98] transition-all duration-200 bg-success-500 hover:bg-success-600"
        >
          Success Alert
        </button>
        <button
          onClick={infoModal.openModal}
          className="px-4 py-2.5 text-sm font-medium text-white rounded-xl tracking-[0.01em] active:scale-[0.98] transition-all duration-200 bg-[#28b8d5] hover:bg-[#22a8c3]"
        >
          Info Alert
        </button>
        <button
          onClick={warningModal.openModal}
          className="px-4 py-2.5 text-sm font-medium text-white rounded-xl tracking-[0.01em] active:scale-[0.98] transition-all duration-200 bg-warning-500 hover:bg-warning-600"
        >
          Warning Alert
        </button>
        <button
          onClick={errorModal.openModal}
          className="px-4 py-2.5 text-sm font-medium text-white rounded-xl tracking-[0.01em] active:scale-[0.98] transition-all duration-200 bg-error-500 hover:bg-error-600"
        >
          Danger Alert
        </button>
      </div>
      ...
      >
        <div className="text-center">
          ...
          <div className="flex items-center justify-center w-full gap-3 mt-7">
            <button
              type="button"
              className="flex justify-center w-full px-5 py-3 text-sm font-medium text-white rounded-xl tracking-[0.01em] active:scale-[0.98] transition-all duration-200 bg-success-500 hover:bg-success-600 sm:w-auto"
            >
              Okay, Got It
            </button>
          </div>
      ...
      >
        <div className="text-center">
          ...
          <div className="flex items-center justify-center w-full gap-3 mt-7">
            <button
              type="button"
              className="flex justify-center w-full px-5 py-3 text-sm font-medium text-white rounded-xl tracking-[0.01em] active:scale-[0.98] transition-all duration-200 bg-[#28b8d5] hover:bg-[#22a8c3] hover:shadow-[0_0_16px_rgba(40,184,213,0.4)] sm:w-auto"
            >
              Okay, Got It
            </button>
          </div>
      ...
      >
        <div className="text-center">
          ...
          <div className="flex items-center justify-center w-full gap-3 mt-7">
            <button
              type="button"
              className="flex justify-center w-full px-5 py-3 text-sm font-medium text-white rounded-xl tracking-[0.01em] active:scale-[0.98] transition-all duration-200 bg-warning-500 hover:bg-warning-600 sm:w-auto"
            >
              Okay, Got It
            </button>
          </div>
      ...
      >
        <div className="text-center">
          ...
          <div className="flex items-center justify-center w-full gap-3 mt-7">
            <button
              type="button"
              className="flex justify-center w-full px-5 py-3 text-sm font-medium text-white rounded-xl tracking-[0.01em] active:scale-[0.98] transition-all duration-200 bg-error-500 hover:bg-error-600 sm:w-auto"
            >
              Okay, Got It
            </button>
          </div>
