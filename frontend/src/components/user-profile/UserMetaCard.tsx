...
export default function UserMetaCard() {
  ...
  return (
    <>
      <div className="p-5 border border-gray-200 rounded-2xl dark:border-white/[0.08] lg:p-6">
        <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
          <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
            <div className="w-20 h-20 overflow-hidden border border-gray-200 rounded-full dark:border-white/[0.08]">
              <Image
                width={80}
                height={80}
            ...
            <div className="order-3 xl:order-2">
              ...
              <div className="flex flex-col items-center gap-1 text-center xl:flex-row xl:gap-3 xl:text-left">
                ...
                <div className="hidden h-3.5 w-px bg-gray-300 dark:bg-white/[0.10] xl:block"></div>
                <p className="text-sm text-gray-500 dark:text-gray-400">
      ...
      <Modal isOpen={isOpen} onClose={closeModal} className="max-w-[700px] m-4">
        <div className="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-[#0f0f0f] lg:p-11">
